...
!1;b.select();document.execCommand("copy");document.body.removeChild(b);a&&(document.getSelection().removeAllRanges(),document.getSelection().addRange(a))};this.initPopover=function(){$('[data-toggle="popover"]').popover();$('[data-toggle="popover"]').on("shown.bs.popover",function(){setTimeout(function(){$('[data-toggle="popover"]').popover("hide")},1E3)})};this.listenOnClickTabName=function(){$("a[data-toggle]").on("shown.bs.tab",function(a){$('a[data-name="'+a.target.dataset.name+'"]').tab("show")})}}).apply(QuinenCake);
