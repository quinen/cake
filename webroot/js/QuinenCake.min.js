...
function(){return"10000000-1000-4000-8000-100000000000".replace(/[018]/g,function(a){return(a^crypto.getRandomValues(new Uint8Array(1))[0]&15>>a/4).toString(16)})}}).apply(Quinen);
...
$.globalEval(a[c].innerHTML)});return!1})};this.drawChart=function(){$("[data-chart]").each(function(a,b){a=b.getContext("2d");return new Chart(a,JSON.parse(b.dataset.chart))})};this.initSelect2=function(){$("select").select2({theme:"bootstrap4",language:"fr",allowClear:!0,placeholder:"",dropdownAutoWidth:!0,escapeMarkup:function(a){return a},templateResult:function(a){return a.html||a.text},templateSelection:function(a){return a.text}}).on("select2:opening",function(){QuinenCake.showLoading=!1}).on("select2:close",
function(){QuinenCake.showLoading=!0}).maximizeSelect2Height()};this.updateFromInputValue=function(){$("[data-from-input-value]").each(function(a,b){a=document.getElementById(this.dataset.fromInputValue.replace(/[._]/g,"-"));$(a).keyup(function(a){b.innerHTML=a.target.value})})};this.listenOnClearForm=function(){$("[data-clear-form]").click(function(a){a=a.target.form.elements;for(var b=0;b<a.length;b++){var c=a.item(b);switch(c.type){case "hidden":break;case "radio":c.checked=!1;default:c.value=
""}}})};this.listenOnDropdownMenu=function(){$(".dropdown-menu .dropdown-toggle").on("click",function(a){$(this).next().hasClass("show")||$(this).parents(".dropdown-menu").first().find(".show").removeClass("show");$(this).next(".dropdown-menu").toggleClass("show");$(this).parents(".nav-item.dropdown.show").on("hidden.bs.dropdown",function(a){$(".dropdown-submenu .show").removeClass("show")});return!1})};this.delayedMap=function(a,b,c){function d(){!a.length||e>=a.length||!1===c(a[e],e,a)||(++e,setTimeout(d,
b))}var e=0;setTimeout(d,b)};this.getDatePlaceholder=function(a){var b=moment().locale(a)._locale;a=b._longDateFormat.L;var c=b._relativeTime.dd.split(" ")[1][0],d=b._relativeTime.MM.split(" ")[1][0];b=b._relativeTime.yy.split(" ")[1][0];return a.replace(/D/g,c).replace(/M/g,d).replace(/Y/g,b)};this.initDatepicker=function(){var a=QuinenCake.getDatePlaceholder("fr");$('[data-toggle="datetimepicker"]').each(function(){var b=$(this),c=$(b.data("date")),d=null;c.val().length&&(d=new Date(c.val()));b.val(moment(d).format("L"));
...
"application/x-www-form-urlencoded")},type:c.attr("method"),url:c.attr("action"),data:c.serialize()}).done(function(a,b,f){c.parents(".container-fluid:first").prepend(QuinenCake.renderFlash(a._message));a=c.parents(".tab-pane:first").attr("id");$('a[data-target="#'+a+'"] .close').click()}).fail(function(a){c.parents(".container-fluid:first").prepend(QuinenCake.renderFlash(a._message));console.dir(arguments);c.prepend(a.content)});a.stopLoading();b.preventDefault();b.stopPropagation()})};this.listenOnClickDataHref=
